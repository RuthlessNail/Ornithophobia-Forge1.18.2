...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    NETHERITE("netherite",37,new int[] {
        3, 6, 8, 3
    ...
    public String getName() {
        return Ornithophobia.MOD_ID+":"+this.name;
    }
